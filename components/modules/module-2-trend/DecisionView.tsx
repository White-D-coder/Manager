...
import { BrainCircuit, CheckCircle, ChevronRight, XCircle } from "lucide-react";
...
export default function DecisionView() {
    ...
    const [winner, setWinner] = useState<TrendItem | null>(null);

    // Create a scored copy for visualization
    const [scoredTrends, setScoredTrends] = useState<TrendItem[]>([]);
