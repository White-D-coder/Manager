...
import { Film, Play, Layers, Clock } from "lucide-react";

export default function VideoStudioView() {
    const { generatedScript, setModule, setVideoAsset, addLog } = useAppStore();
    const [asset, setLocalAsset] = useState<VideoAsset | null>(null);
    const [progress, setProgress] = useState(0);

    const [sectionVideos, setSectionVideos] = useState<Record<string, string>>({});
